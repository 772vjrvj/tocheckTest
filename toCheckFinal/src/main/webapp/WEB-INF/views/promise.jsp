...
<body>
<form action="promiseCheck.do?id=${map.id}&pKey=${map.pKey}" method="post">
<div id="container">
<div id="content">
...
<p>동의하십니까?<input type="checkbox" name="promise" required="required"> &nbsp; <img id="stap" src="img/stamp.jpg"></p>
<input type="button" value="취소" onclick="location.href='habitCalDetail.do?id=${map.id}&pKey=${map.pKey}&paramview=1'"/><input type="submit"  value="확인"/>
</div>
</div>
</form>
</body>
