...
public class HcLoginDto {
	...
	private int ttpoint; // 토탈 포인트
	private String tdpoint; //출석포인트를 주기위한 날짜를 받는 컬럼
	...
	public HcLoginDto(int seq, String id, String name, String password, String address, String phone, String email,
			String enabled, String role, int ttpoint, String tdpoint) {
		super();
		this.seq = seq;
		this.id = id;
		this.name = name;
	...
	public int getTtpoint() {
		return ttpoint;
	}

	public void setTtpoint(int ttpoint) {
		this.ttpoint = ttpoint;
	}

	public String getTdpoint() {
		return tdpoint;
	}

	public void setTdpoint(String tdpoint) {
		this.tdpoint = tdpoint;
	}
	...
	public String toString() {
		return "HcLoginDto [seq=" + seq + ", id=" + id + ", name=" + name + ", password=" + password + ", address="
				...
				+ ", ttpoint=" + ttpoint + ", tdpoint=" + tdpoint + "]";
	}
